...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        if self.is_mixup:
            ...
            # mixup xs_pad, ilens
            bsz = xs_pad.shape[0]
            xs_pad_mix = lambda_* xs_pad + (1-lambda_)*xs_pad[index, :, :]
            ys_pad_mix = ys_pad
        ...
        if self.mtlalpha == 0:
            ...
            if self.is_mixup:
                ...
                self.loss_ctc_mix = lambda_ * self.ctc(hs_pad_mix, hlens_mix, ys_pad_mix) + (1 - lambda_) * self.ctc(hs_pad_mix, hlens_mix, ys_pad_mix[index, :])
