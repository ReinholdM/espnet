...
datadir=/var/storage/shared/msrmt/v-jinx/data/librispeech_asr_data
datapredix=/var/storage/shared/msrmt/v-jinx/data/librispeech_asr_data/LibriSpeech/espnet
